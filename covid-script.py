...
face_covering_policy = pd.read_csv("face-covering-policies-covid.csv", low_memory=False)
face_covering_policy["Day"] = pd.to_datetime(face_covering_policy["Day"])
# public events
public_events_policy = pd.read_csv("public-events-covid.csv", low_memory=False)
public_events_policy["Day"] = pd.to_datetime(face_covering_policy["Day"])
public_gathering_policy = pd.read_csv(
    "public-gathering-rules-covid.csv", low_memory=False
)
public_gathering_policy["Day"] = pd.to_datetime(public_gathering_policy["Day"])
# internal movements policy
internal_movement_policy = pd.read_csv("internal-movement-covid.csv", low_memory=False)
...
international_travel_policy = pd.read_csv(
    "international-travel-covid.csv", low_memory=False
)
international_travel_policy["Day"] = pd.to_datetime(international_travel_policy["Day"])
# testing policy
testing_policy = pd.read_csv("covid-19-testing-policy.csv", low_memory=False)
