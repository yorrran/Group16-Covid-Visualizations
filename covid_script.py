...
print("country_vaccines_used:", country_vaccines_used["PERSONS_FULLY_VACCINATED_PER100"].max())
...
globalDf=globalDf[globalDf['New_cases'] >=0]
globalDf=globalDf[globalDf['New_deaths'] >=0]
...
country_vaccines_used.to_csv("country_vaccines_used.csv", index=False)
# stringency index
owid_covid_data_USA_Singapore = pd.read_csv("origin_data/owid-covid-data.csv", low_memory=False)
owid_covid_data_USA_Singapore = owid_covid_data_USA_Singapore.loc[owid_covid_data_USA_Singapore["location"].isin(["United States", "Singapore"])]
print("owid_covid_data_USA_Singapore:",owid_covid_data_USA_Singapore)
owid_covid_data_USA_Singapore.to_csv("processed_data/owid_covid_data_USA_Singapore.csv", index=False)
...
face_covering_policy_USA_Singapore = face_covering_policy.loc[face_covering_policy["Entity"].isin(["United States", "Singapore"])]
face_covering_policy_USA_Singapore.to_csv("processed_data/face_covering_policy_USA_Singapore.csv", index=False)
...
public_events_policy_USA_Singapore = public_events_policy.loc[public_events_policy["Entity"].isin(["United States", "Singapore"])]
public_events_policy_USA_Singapore.to_csv("processed_data/public_events_policy_USA_Singapore.csv", index=False)
...
public_gathering_policy_USA_Singapore = public_gathering_policy.loc[public_gathering_policy["Entity"].isin(["United States", "Singapore"])]
public_gathering_policy_USA_Singapore.to_csv("processed_data/public_gathering_policy_USA_Singapore.csv", index=False)
# internal_movement_policy["Day"] = pd.to_datetime(internal_movement_policy["Day"])
internal_movement_policy_USA_Singapore = internal_movement_policy.loc[internal_movement_policy["Entity"].isin(["United States", "Singapore"])]
internal_movement_policy_USA_Singapore.to_csv("processed_data/internal_movement_policy_USA_Singapore.csv", index=False)
...
international_travel_policy_USA_Singapore = international_travel_policy.loc[international_travel_policy["Entity"].isin(["United States", "Singapore"])]
international_travel_policy_USA_Singapore.to_csv("processed_data/international_travel_policy_USA_Singapore.csv", index=False)
# testing policy
...
testing_policy_USA_Singapore = testing_policy.loc[testing_policy["Entity"].isin(["United States", "Singapore"])]
testing_policy_USA_Singapore.to_csv("processed_data/testing_policy_USA_Singapore.csv", index=False)
# policies = [
